...
public class Switches_Cfs {

	static BufferedReader BR;
	public static void main(String[] args) throws NumberFormatException, IOException {
		// TODO Auto-generated method stub

		Switches_Cfs cfs =new Switches_Cfs();
	...
	private void table1() throws IOException {
		// TODO Auto-generated method stub
		System.out.println("Enter A Table No");
		String Table1 = BR.readLine();
		if (Table1.equals("A") || (Table1.equals("a")) && (Table1.equals("b"))) {
